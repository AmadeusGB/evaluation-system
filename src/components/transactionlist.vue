<template>
    <div>
        ...
        <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;共10006个交易被发现</span>
        <el-table ref="multipleTable" :data="tableData" border style="width: 100%" @selection-change="handleSelectionChange">
            <el-table-column type="selection" width="60"></el-table-column>
            <el-table-column prop="eNumber" label="区块ID" width="180" sortable></el-table-column>
            <el-table-column prop="eName" label="交易ID" show-overflow-tooltip></el-table-column>
            <el-table-column prop="eIndustry" label="创建时间戳（UTC)" width="280"></el-table-column>
